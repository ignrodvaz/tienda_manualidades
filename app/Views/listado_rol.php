									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('rol/exportar?' . http_build_query(array_merge($_GET, [
														'NOMBRE' => $name,
													...
													<tr class="<?= isset($rol['FECHA_BAJA']) && $rol['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
														...
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= base_url('rol/delete/' . esc($rol['PK_ID_ROL'])) ?>"  class="menu-link px-3" data-kt-users-table-filter="delete_row"><?= isset($rol['FECHA_BAJA']) ? 'Dar de Alta' : 'Dar de Baja' ?></a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
