										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											<thead>
												<tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    ...
                                                    <th class="text-center">DIRECCION PEDIDO</th>
											...
											<tbody class="text-gray-700 fw-bold">
                                                <?php foreach ($pedidos as $pedido): ?>
                                                    <tr class="<?= isset($pedido['FECHA_BAJA']) && $pedido['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
                                                        ...
                                                        <td class="text-center"><?= esc($pedido['CLIENTE_NOMBRE']) ?></td>
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= base_url('pedido/delete/' . esc($pedido['PK_ID_PEDIDO'])) ?>"   class="menu-link px-3" data-kt-users-table-filter="delete_row">Eliminar</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
