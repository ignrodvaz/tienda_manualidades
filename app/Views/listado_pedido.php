			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
						<a href="<?= base_url('logout') ?>" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Cerrar sesión">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<!--begin::Title-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Pedido</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<form action="<?= base_url('pedido')?>">
													<input type="text" name="FK_ID_CLIENTE" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar" value="<?= esc($fk_id_cliente) ?>"/>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<?php endif; ?>
													<!--begin::Content-->
													<form id="formularioListadoPedido" action="<?= base_url('pedido')?>">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('pedido/exportar?' . http_build_query(array_merge($_GET, [
												...
												<!--end::Export-->
												<!--begin::Add user-->
												<a href="<?=base_url('pedido/save')?>" type="button" class="btn btn-primary">
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-header" id="kt_modal_add_user_header">
															<!--begin::Modal title-->
															<h2 class="fw-bolder"><?= isset($pedido['PK_ID_PEDIDO']) ? 'Editar Pedido' : 'Crear Pedido' ?></h2>
															<!--end::Modal title-->
															<!--begin::Close-->
															<div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
																<a href="categoria">
									...
									<div class="card-body pt-0">
											...
											<thead>
												<tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'FECHA_PEDIDO', 'order_direccion' => ($order_columna == 'FECHA_PEDIDO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Fecha Pedido <?= ($order_columna == 'FECHA_PEDIDO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'DIRECCION_PEDIDO', 'order_direccion' => ($order_columna == 'DIRECCION_PEDIDO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Dirección Pedido <?= ($order_columna == 'DIRECCION_PEDIDO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'TOTAL_PEDIDO', 'order_direccion' => ($order_columna == 'TOTAL_PEDIDO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Total Pedido <?= ($order_columna == 'TOTAL_PEDIDO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'ESTADO', 'order_direccion' => ($order_columna == 'ESTADO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Estado <?= ($order_columna == 'ESTADO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'CLIENTE_NOMBRE', 'order_direccion' => ($order_columna == 'CLIENTE_NOMBRE' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Cliente <?= ($order_columna == 'CLIENTE_NOMBRE') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
											...
											<tbody class="text-gray-700 fw-bold">
                                                <?php foreach ($pedidos as $pedido): ?>
                                                    <tr class="<?= isset($pedido['FECHA_BAJA']) && $pedido['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
                                                        ...
                                                        <td class="text-center"><?= isset($pedido['CLIENTE_NOMBRE']) ? $pedido['CLIENTE_NOMBRE'] : 'Sin Cliente'; ?></td>
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= base_url('pedido/save/' . $pedido['PK_ID_PEDIDO']) ?>"  class="menu-link px-3">Editar</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
										...
										<script>
											document.getElementById('perPage').addEventListener('change', function() {
												...
												document.getElementById('formularioListadoPedido').submit()
											});
										</script>
