						...
						<div class="toolbar top-0" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
										<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Producto</h1>
										<!--end::Title-->
										<!--begin::Separator-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Producto</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<?php endif; ?>
													<!--begin::Content-->
													<form id="formularioListadoProducto" action="<?= base_url('producto')?>">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('producto/exportar?' . http_build_query(array_merge($_GET, [
													'NOMBRE' => $name,
													'DESCRIPCION' => $descripcion,
													'PRECIO' => $precio,
													'STOCK' => $stock,
													'CATEGORIA_NOMBRE' => $fk_id_categoria,
												...
												<!--end::Export-->
												<!--begin::Add user-->
												<a href="<?=base_url('producto/save')?>" type="button" class="btn btn-primary">
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-header" id="kt_modal_add_user_header">
															<!--begin::Modal title-->
															<h2 class="fw-bolder"><?= isset($pedido['PK_ID_PRODUCTO']) ? 'Editar Producto' : 'Crear Producto' ?></h2>
															<!--end::Modal title-->
															<!--begin::Close-->
															<div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
																<a href="categoria">
									...
									<div class="card-body pt-0">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											<thead>
												<tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    ...
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'DESCRIPCION', 'order_direccion' => ($order_columna == 'DESCRIPCION' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Descripción <?= ($order_columna == 'DESCRIPCION') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'PRECIO', 'order_direccion' => ($order_columna == 'PRECIO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Precio <?= ($order_columna == 'PRECIO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'STOCK', 'order_direccion' => ($order_columna == 'STOCK' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Stock <?= ($order_columna == 'STOCK') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'CATEGORIA_NOMBRE', 'order_direccion' => ($order_columna == 'CATEGORIA_NOMBRE' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Nombre categoria <?= ($order_columna == 'CATEGORIA_NOMBRE') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
											...
											<tbody class="text-gray-700 fw-bold">
                                                <?php foreach ($productos as $producto): ?>
                                                    <tr class="<?= isset($producto['FECHA_BAJA']) && $producto['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
                                                        <td class="text-center"><?= esc($producto['NOMBRE']) ?></td>
                                                        <td class="text-center"><?= esc($producto['DESCRIPCION']) ?></td>
                                                        <td class="text-center"><?= esc($producto['PRECIO']) ?></td>
                                                        <td class="text-center"><?= esc($producto['STOCK']) ?></td>
                                                        <td class="text-center"><?= esc($producto['CATEGORIA_NOMBRE']) ?></td>
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= base_url('producto/save/' . $producto['PK_ID_PRODUCTO']) ?>"  class="menu-link px-3">Editar</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= base_url('producto/delete/' . esc($producto['PK_ID_PRODUCTO'])) ?>"   class="menu-link px-3" data-kt-users-table-filter="delete_row"><?= isset($producto['FECHA_BAJA']) ? 'Dar de Alta' : 'Dar de Baja' ?></a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
										...
										<script>
											document.getElementById('perPage').addEventListener('change', function() {
												...
												document.getElementById('formularioListadoProducto').submit()
											});
										</script>
