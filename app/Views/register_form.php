			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" >
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="<?= base_url('register/authenticate') ?>" method="post">
							<!--begin::Heading-->
							<?= csrf_field() ?>
							...
							<div class="mb-10 text-center">
								...
								<a href="login" class="link-primary fw-bolder">Inicia sesión aquí</a></div>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							<!--begin::Separator-->
							...
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid" type="password" placeholder="Tu contraseña" name="password" id="password" autocomplete="off" />
								...
								<!--end::Wrapper-->
								<!--begin::Hint-->
								<div class="text-muted">Utilice 8 o más caracteres con una mezcla de letras, números &amp; símbolos.</div>
								<!--end::Hint-->
							</div>
							<!--end::Input group=-->
							<!--begin::Input group-->
