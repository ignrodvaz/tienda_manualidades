								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<!--begin::Title-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Crear Producto</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div id="kt_content_container" class="container-xxl">
									<!--begin::Card-->
										<div class="card mb-5 mb-xl-8">
											<!--begin::Card body-->
											<div class="card-body">
												<h1 class="d-flex flex-center flex-column py-5"><?= isset($producto['PK_ID_PRODUCTO']) ? 'Editar Producto' : 'Crear Producto' ?></h1>
												...
												<form action="<?= isset($producto) ? base_url('producto/save/') . $producto['PK_ID_PRODUCTO'] : base_url('producto/save') ?>" method="post">
													...
													<div class="d-flex d-flex justify-content-end py-3 mb-3">
														<button type="submit" id="submitButton" class="btn me-3 btn-primary"><?= isset($producto) ? 'Actualizar' : 'Guardar'?></button>
                                                	...
                                                	<div class="separator"></div>
														...
														<div id="kt_user_view_details" class="collapse show">
															<div class="pb-5 fs-6">
																...
																<div class="text-gray-600"><?= isset($producto) ? esc($producto['PK_ID_PRODUCTO']) : 'Nuevo' ?></div>
																<!--begin::Details item-->
                                                                <div class="fw-bolder mt-5">ID Categoria</div>
																<div class="text-gray-600"><?= isset($producto) && $producto['FK_ID_CATEGORIA'] !== null ? esc($producto['FK_ID_CATEGORIA']) : 'NULL' ?></div>
                                                                <!--begin::Details item-->
