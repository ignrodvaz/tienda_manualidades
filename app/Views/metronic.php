...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" src="<?= base_url("../assets/media/logos/Logo LPT.png")?>/>
		<!--begin::Fonts-->
							...
							<div id="kt_content_container" class="container-xxl">
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body pt-2" id="ventas">
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1">Categorias</span>
												</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body py-3" style="margin-left: 150px;" id="categoria">
											</div>
											<!--begin::Body-->
										</div>
										<!--end::Tables Widget 9-->
								...
								<div class="row gy-5 g-xl-8">
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body pt-2" id="chart">
									...
									<div class="col-xl-8">
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1">Ventas y pedidos</span>
												</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body py-3"  id="ventasPedidos">
											</div>
											<!--begin::Body-->
										</div>
										<!--end::Tables Widget 9-->
