									...
									<div class="col-xxl-4">
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
												<div class="d-flex flex-stack flex-wrap flex-grow-1 px-6 pt-6 pb-2">
													<div class="me-2">
														<span class="fw-bolder text-gray-800 d-block fs-3">Categorias</span>
													</div>
												</div>
												<!--begin::Stats-->
												<div class="flex-grow-1 card-p pb-0" id="categoria">
												</div>
												<!--end::Stats-->
											</div>
											<!--end::Body-->
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
												...
												<!--begin::Stats-->
												<div class="flex-grow-1 card-p pb-0" id="ventas">
												</div>
												<!--end::Stats-->
											</div>
											<!--end::Body-->
