						...
						<div class="toolbar top-0" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
										<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Detalle Pedido</h1>
										<!--end::Title-->
										<!--begin::Separator-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Detalle Pedido</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<form action="<?= base_url('detalle_pedido')?>">
													<input type="text" name="PRODUCTO_NOMBRE" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar" value="<?= esc($producto_nombre) ?>"/>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<?php endif; ?>
													<!--begin::Content-->
													<form id="formularioListadoDetalle" action="<?= base_url('detalle_pedido')?>">
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															<!--begin::Input group-->
															<div class="mb-3">
                                                                <input type="text" name="CANTIDAD" class="form-control" placeholder="Cantidad" value="<?= esc($cantidad) ?>">															</div>
															<div class="mb-3">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('detalle_pedido/exportar?' . http_build_query(array_merge($_GET, [
													'PK_ID_DETALLE' => $pk_id_detalle,
													'CANTIDAD' => $cantidad,
												...
												<!--end::Export-->
												<!--begin::Add user-->
												<a href="<?=base_url('detalle_pedido/save')?>" type="button" class="btn btn-primary">
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-header" id="kt_modal_add_user_header">
															<!--begin::Modal title-->
															<h2 class="fw-bolder"><?= isset($detalle['PK_ID_DETALLE']) ? 'Editar Detalle Pedido' : 'Crear Detalle Pedido' ?></h2>
															<!--end::Modal title-->
															<!--begin::Close-->
															<div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
																<a href="categoria">
									...
									<div class="card-body pt-0">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											<thead>
												<tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    ...
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'PRECIO_UNITARIO', 'order_direccion' => ($order_columna == 'PRECIO_UNITARIO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Precio <?= ($order_columna == 'PRECIO_UNITARIO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'FK_ID_PEDIDO', 'order_direccion' => ($order_columna == 'FK_ID_PEDIDO' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">ID Pedido <?= ($order_columna == 'FK_ID_PEDIDO') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
                                                    <th class="text-center">
														<a href="<?= current_url() . '?' . http_build_query(array_merge($_GET, ['order_columna' => 'PRODUCTO_NOMBRE', 'order_direccion' => ($order_columna == 'PRODUCTO_NOMBRE' && $order_direccion == 'asc') ? 'desc' : 'asc'], ['perPage' => $perPage])) ?>">Producto <?= ($order_columna == 'PRODUCTO_NOMBRE') ? ($order_direccion == 'asc' ? '↑' : '↓') : '' ?></a>
													</th>
										...
										<script>
											document.getElementById('perPage').addEventListener('change', function() {
												...
												document.getElementById('formularioListadoDetalle').submit()
											});
										</script>
