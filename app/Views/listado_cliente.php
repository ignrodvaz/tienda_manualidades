								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<!--begin::Title-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Cliente</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-header" id="kt_modal_add_user_header">
															<!--begin::Modal title-->
															<h2 class="fw-bolder"><?= isset($cliente['PK_ID_CLIENTE']) ? 'Editar Cliente' : 'Crear Cliente' ?></h2>
															<!--end::Modal title-->
															<!--begin::Close-->
															<div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
																<a href="categoria">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-700 fw-bold">
                                                <?php foreach ($clientes as $cliente): ?>
                                                    <tr class="<?= isset($cliente['FECHA_BAJA']) && $cliente['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
                                                        <td class="text-center"><?= esc($cliente['NOMBRE']) ?></td>
														...
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= base_url('cliente/save/' . $cliente['PK_ID_CLIENTE']) ?>"  class="menu-link px-3">Editar</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= base_url('cliente/delete/' . esc($cliente['PK_ID_CLIENTE'])) ?>"  class="menu-link px-3" data-kt-users-table-filter="delete_row"><?= isset($cliente['FECHA_BAJA']) ? 'Dar de Alta' : 'Dar de Baja' ?></a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
