...
<div class="container w-100 mt-5">
    ...
    <form action="<?= base_url('cliente')?>" class="mb-3">
        <div class="container d-flex">
            <a href="<?=base_url('cliente/save')?>" class="btn btn-primary w-auto me-1">Crear Cliente</a>
            <div class="input-group">
                ...
                <input type="text" name="CONTRASENA" class="form-control" placeholder="Contrasena" value="<?= esc($contrasena) ?>">
            ...
            <div class="d-flex align-items-center ms-1">
                <select name="estado" id="estado" class="form-control w-auto h-100 me-1 selectpicker">
