									...
									<div class="card-body pt-0">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-700 fw-bold">
												<?php foreach ($categorias as $categoria): ?>
													<tr class="<?= isset($categoria['FECHA_BAJA']) && $categoria['FECHA_BAJA'] !== null ? 'bg-light-danger' : '' ?>">
														<td class="text-center"><?= esc($categoria['NOMBRE']) ?></td>
														<td class="text-center"><?= esc($categoria['DESCRIPCION']) ?></td>
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= base_url('categoria/save/'. esc($categoria['PK_ID_CATEGORIA'])) ?>"  class="menu-link px-3">Editar</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
										...
										<script>
											document.getElementById("perPage").addEventListener("change", function() {
												...
												document.getElementById("formularioListadoCategoria").submit();  // Envía el formulario
											});
										</script>
