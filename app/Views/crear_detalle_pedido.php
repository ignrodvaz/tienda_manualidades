								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<!--begin::Title-->
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Crear Detalle Pedido</li>
											<!--end::Item-->
										</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div id="kt_content_container" class="container-xxl">
									<!--begin::Card-->
										<div class="card mb-5 mb-xl-8">
											<!--begin::Card body-->
											<div class="card-body">
												<h1 class="d-flex flex-center flex-column py-5"><?= isset($detalle['PK_ID_DETALLE']) ? 'Editar Detalle Pedido' : 'Crear Detalle Pedido' ?></h1>
												...
												<form action="<?= isset($detalle) ? base_url('detalle_pedido/save/') . $detalle['PK_ID_DETALLE'] : base_url('detalle_pedido/save') ?>" method="post">
													...
													<div class="d-flex d-flex justify-content-end py-3 mb-3">
														<button type="submit" id="submitButton" class="btn me-3 btn-primary"><?= isset($detalle) ? 'Actualizar' : 'Guardar'?></button>
                                                	...
                                                	<div class="separator"></div>
														...
														<div id="kt_user_view_details" class="collapse show">
															<div class="pb-5 fs-6">
																<!--begin::Details item-->
																<div class="fw-bolder mt-5">ID Detalle pedido</div>
																<div class="text-gray-600"><?= isset($detalle) ? esc($detalle['PK_ID_DETALLE']) : 'Nuevo' ?></div>
																<!--begin::Details item-->
                                                                <div class="fw-bolder mt-5">ID Pedido</div>
																<div class="text-gray-600"><?= isset($detalle) && $detalle['FK_ID_PEDIDO'] !== null ? esc($detalle['FK_ID_PEDIDO']) : 'NULL' ?></div>
                                                                <!--begin::Details item-->
                                                                <div class="fw-bolder mt-5">ID Producto</div>
																<div class="text-gray-600"><?= isset($detalle) && $detalle['FK_ID_PRODUCTO'] !== null ? esc($detalle['FK_ID_PRODUCTO']) : 'NULL' ?></div>
                                                                <!--begin::Details item-->
